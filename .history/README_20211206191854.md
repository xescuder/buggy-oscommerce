...
Many test trainings are based on test automation of applications. I found difficult to explain exploratory testing or bug hunting with the common web applications, as they have usually not many bugs.
