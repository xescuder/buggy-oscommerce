...
Store ower e-mail address: xescuder@gmail.com

Administrator username: root

Administrator password: upcschool

Administration directory name: admin

Time zone: UTC

7. Get a free API Key at [https://example.com](https://example.com)
8. Clone the repo
   ```sh
...
11. Enter your API in `config.js`
